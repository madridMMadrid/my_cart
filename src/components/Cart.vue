        ...
        <div>
            ...
            <div class="products">
                <div class="product_card" v-for="(product, i) in categoryProducts" :key="i">
                    ...
                    <div v-for="group in product.options">
                        <label
                                :for="'label_select_' + group.product_option_id">
                            {{group.name}}
                        </label>
                        <select
                            ...
                            <template v-for="all_options in group.product_option_value">
                                <option
                                        :value="all_options.product_option_value_id">{{all_options.name}} = [{{group.product_option_id}}:{{all_options.product_option_value_id}}]
                                </option>
                            </template>
                        </select>
                    </div>
                    <button
                            @click="timAddProductToCart(product.product_id)"
                    >Добавить в корзину
                    </button>
                </div>
                <hr/>
            ...
            <div class="order_block form_border_style clearfix">
                ...
                <div class="left">
                    ...
                    <div class="fields_wrap">
                        ...
                        >Меньше {{$v.fio.$params.minLength.min}} символов.
                        </div>
                        <div
                                class="error"
                                v-if="!$v.fio.maxLength"
                        >Больше {{$v.fio.$params.maxLength.max}} символов.
                        </div>
        ...
        methods: {
            ...
            timAddProductToCart(product_id) {
                makeAjax(
                    ...
                    'product_id=' + product_id + (this.selectOptions[product_id] ? this.selectOptions[product_id] : ''),
                    (response) => {
